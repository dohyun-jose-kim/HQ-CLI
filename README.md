...
```
# 파싱 버전 선택 (1 또는 2)
[개발 모드] 사용할 파싱 버전을 선택하세요:
  1. v1  —  difflib 기반 fuzzy 매핑
  2. v2  —  TF-IDF 코사인 유사도 ML
선택 (번호): 2
...
> **파싱 버전 선택에 대해:** `main.py` 의 `DEV_MODE = True` 상태에서는 실행 시 파싱 방식을 직접 선택할 수 있습니다. 현재 기본값은 **v2 (TF-IDF)** 입니다.
